...
Every feature row against every analyzed project. 77 rows ×
35 projects, unfiltered — nothing is dropped for being rare.
...
all 53 against all 35. The Cicero band records
...
| **Cicero capabilities (9)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| CD-1 · Embeddable venue/exhibitor-hall map (organizer PDF upload, public widget) | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| CD-2 · Sponsors / exhibitors with a publication-gated public wall | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✓ | ✗ | ✗ | ~ | ~ | ✗ | ✗ | ✗ | ✗ | ✗ | ✓ | ✗ | ✗ | ✓ | ✗ | ✗ | ✗ | ~ | ✗ | ✗ | ✓ | ✗ | ✗ | ✗ |
| CD-3 · Consent-aware SMS (E.164 normalization, OTP verification, quiet hours) | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| CD-4 · Streamable-HTTP MCP server with role-scoped agent skills | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| CD-5 · Post-conference recording ingestion with publication gates | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| CD-6 · Signed outbound webhooks | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| CD-7 · Cross-event speaker CRM (segments, sourcing) | ✓ | ✓ | ✓ | ✓ | ~ | ✗ | ✓ | ✗ | ✓ | ✗ | ✓ | ✓ | ✓ | ✓ | ✗ | ✓ | ~ | ~ | ~ | ✗ | ✓ | ✗ | ✓ | ✗ | ✓ | ~ | ✓ | ✓ | ✓ | ✓ | ~ | ~ | ✗ | ✓ | ✓ | ✓ |
| CD-8 · Versioned public REST API with a generated OpenAPI contract | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ~ | ✓ | ~ | ✗ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ~ | ✓ | ✗ | ✗ | ~ | ✓ | ✗ | ✓ | ✓ | ✓ | ✗ | ~ | ✗ | ✗ | ✓ |
| CD-9 · Reversible CRM merges | ✓ | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? |
