...
describe('0003_event_deadlines', () => {
  const statements = migration('0003_event_deadlines');

  /**
   * `AR-49`. Two columns on a table that already exists, and nothing else. It is worth pinning
