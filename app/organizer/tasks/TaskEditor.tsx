...
const KINDS: Array<{ value: OrganizerTaskRow['kind']; label: string; hint: string }> = [
...
const AUDIENCES: Array<{ value: OrganizerTaskRow['audience']; label: string }> = [
 ...
 */
const SCOPES: Array<{ value: OrganizerTaskRow['scope']; label: string; hint: string }> = [
  {
    value: 'contact',
    label: 'Per contact',
...
export function draftFrom(row: OrganizerTaskRow): TaskFormInput {
  return {
    name: row.name,
      ...
      <div className={styles.form}>
        ...
        <div className={styles.row}>
          <label className={styles.field}>
            ...
            <Select
              value={draft.kind}
              onChange={(event) => set('kind', event.target.value as OrganizerTaskRow['kind'])}
            >
              {KINDS.map((entry) => (
          ...
          <label className={styles.field}>
            ...
            <Select
              ...
              onChange={(event) => set('audience', event.target.value as OrganizerTaskRow['audience'])}
            >
              {AUDIENCES.map((entry) => (
                <option key={entry.value} value={entry.value}>
                  {entry.label}
        ...
        <div className={styles.row}>
          <label className={styles.field}>
            ...
            <Select
              value={draft.scope}
              onChange={(event) => set('scope', event.target.value as OrganizerTaskRow['scope'])}
            >
              {SCOPES.map((entry) => (
                <option key={entry.value} value={entry.value}>
                  {entry.label}
