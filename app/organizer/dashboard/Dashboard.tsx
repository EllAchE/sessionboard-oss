...
export type DashboardData = {
  eventName: string;
  /**
   * `AR-44`. Described on the server so the strip reads one clock. Empty when the edition tracks
  ...
  return (
    <div className={styles.page}>
      <div className={styles.pageHead}>
        ...
        {/*
          `AR-44`. Outside the widget grid on purpose: the milestones apply to the edition rather
