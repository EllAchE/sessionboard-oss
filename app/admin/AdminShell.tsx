...
const NAV: { id: string; title: string; items: NavEntry[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sponsors', label: 'Sponsors', href: '/admin/sponsors', icon: <Building2 size={15} /> },
      { id: 'exhibitor-map', label: 'Exhibitor map', href: '/admin/exhibitor-map', icon: <MapIcon size={15} /> },
