...
export const CICERO_TRANSPARENT_ASSETS = [
  {
    ...
    recommendedFor: ['speaker placeholder', 'hero edge', 'editorial portrait'],
  ...
  },
  {
    ...
    recommendedFor: ['empty state', 'feature edge', 'speaker workflow'],
  ...
  {
    id: 'speaker-rostrum',
    name: 'Speaker rostrum',
    path: '/assets/roman/illustrations/speaker-rostrum.png',
    kind: 'original illustration',
    orientation: 'landscape',
    alt: 'An illustrated stone speaker rostrum with rolled programmes, laurel, and a vermilion ribbon.',
    recommendedFor: ['onboarding', 'call for speakers', 'speaker empty state'],
  ...
  },
  {
    ...
    recommendedFor: ['review queue', 'scorecard empty state', 'decision feature'],
    provenance: 'Original OpenAI-generated Cicero illustration',
  },
  {
    id: 'agenda-theatre',
    ...
    recommendedFor: ['agenda builder', 'public programme', 'schedule empty state'],
    provenance: 'Original OpenAI-generated Cicero illustration',
  },
